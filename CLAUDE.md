...
Single-page HTML course site for **{{COURSE_TITLE_ZH-TW}}** ({{TITLE_EN-US}})
...
│                           or                                    │
│     └─► src/subtitles/*_en_youtube_autogen.srt (reference)      │
│                                                                 │
...
│     Input:  src/inputs/*.mp4 (1+ course videos)             │
...
│     Input:  src/subtitles/*_zh-TW_visual.srt (1+ files)     │
...
│     Output: {{COURSE_TITLE_EN-US}}_transcript.html (repo root)    │
